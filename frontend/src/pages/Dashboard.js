                ...
                {!hasPremiumAccess ? (
                  <div className="relative">
                        ...
                        {[1, 2, 3].map((idx) => (
                          <div key={idx} className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                            <div className="flex items-start gap-2 mb-1">
                              ...
                              <p className="text-sm font-semibold text-slate-900">Sample Category</p>
                            </div>
                            <p className="text-sm text-slate-700 mb-2">Sample insight text that is blurred...</p>
                            <div className="text-xs text-slate-600 mb-1">
                              <span className="text-red-600">Current: XX</span>
                              <span className="mx-2">→</span>
                              <span className="text-green-600">Target: YY</span>
                            </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-transparent via-white/80 to-white">
                      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-lg border-2 border-brand-blue">
                        <div className="text-center mb-6">
                          ...
                          <h3 className="text-2xl font-bold text-slate-900 mb-2">Unlock Complete Financial Analysis</h3>
                          <p className="text-slate-600">Get personalized insights to improve your financial health</p>
                        </div>

                        {/* Individual Plan */}
                        <div className="bg-gradient-to-br from-blue-50 to-white border-2 border-brand-blue rounded-xl p-6 mb-4">
