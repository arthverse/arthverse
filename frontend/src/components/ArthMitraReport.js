...
export default function ArthMitraReport({ userData, healthScore, questionnaire }) {
  ...
  return (
    <div className="arthm-page">
      ...
      {/* FINANCIAL STABILITY & CREDIT CARDS QUESTIONNAIRE */}
      <div className="sh an in"><div className="shn">4.1</div><div className="sht">Financial Stability & Credit Cards</div><div className="shl"></div><div className="shb">7 checkpoint questions that determine your financial discipline score</div></div>
      <div className="an in" style={{background:'var(--bg2)',border:'1px solid var(--border)',borderRadius:'var(--r16)',overflow:'hidden',marginBottom:'20px'}}>
        <table style={{width:'100%',borderCollapse:'collapse',fontSize:'12px'}}>
          <thead>
            <tr style={{background:'var(--t0)'}}>
              <th style={{padding:'12px 16px',textAlign:'left',color:'#fff',fontWeight:700,fontSize:'11px',letterSpacing:'.05em',width:'40px'}}>#</th>
              <th style={{padding:'12px 16px',textAlign:'left',color:'#fff',fontWeight:700,fontSize:'11px',letterSpacing:'.05em'}}>CHECKPOINT QUESTION</th>
              <th style={{padding:'12px 16px',textAlign:'left',color:'#fff',fontWeight:700,fontSize:'11px',letterSpacing:'.05em',width:'45%'}}>ANSWER OPTIONS</th>
            </tr>
          </thead>
          <tbody>
            {/* Q1 - Orange */}
            <tr style={{background:'#FEF3C7',borderBottom:'1px solid var(--border)'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#B45309',verticalAlign:'top'}}>Q1</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#92400E',verticalAlign:'top',lineHeight:1.5}}>Do you have a personal health insurance policy (not just employer-provided)?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#78350F',lineHeight:1.8}}>
                  <div>A. Yes – Personal/family floater policy (≥ ₹5L cover)</div>
                  <div>B. No – Only employer-provided health cover</div>
                  <div style={{color:'#DC2626'}}>C. No health insurance at all</div>
                </div>
              </td>
            </tr>
            {/* Q2 - Orange */}
            <tr style={{background:'#FFEDD5',borderBottom:'1px solid var(--border)'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#C2410C',verticalAlign:'top'}}>Q2</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#9A3412',verticalAlign:'top',lineHeight:1.5}}>Do you have a pure Term Life Insurance policy?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#7C2D12',lineHeight:1.8}}>
                  <div>A. Yes – Pure term plan (coverage ≥ 10× annual income)</div>
                  <div>B. No – Only ULIP/Endowment/LIC money-back plan</div>
                  <div style={{color:'#DC2626'}}>C. No life insurance at all</div>
                </div>
              </td>
            </tr>
            {/* Q3 - Green */}
            <tr style={{background:'#DCFCE7',borderBottom:'1px solid var(--border)'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#166534',verticalAlign:'top'}}>Q3</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#15803D',verticalAlign:'top',lineHeight:1.5}}>Do you file your Income Tax Return (ITR) every year before the deadline?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#14532D',lineHeight:1.8}}>
                  <div>A. Yes – Always on time, and I check Form 26AS/claim TDS refunds</div>
                  <div>B. Yes – But usually after the deadline</div>
                  <div>C. Only when required (loan/visa application)</div>
                  <div>D. No – I do not file ITR</div>
                </div>
              </td>
            </tr>
            {/* Q4 - Gray */}
            <tr style={{background:'#F3F4F6',borderBottom:'1px solid var(--border)'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#374151',verticalAlign:'top'}}>Q4</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#4B5563',verticalAlign:'top',lineHeight:1.5}}>Do you carry a credit card?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#1F2937',lineHeight:1.8}}>
                  <div>A. Yes</div>
                  <div>B. No</div>
                </div>
              </td>
            ...
            {/* Q5 - Red */}
            <tr style={{background:'#FEE2E2',borderBottom:'1px solid var(--border)'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#991B1B',verticalAlign:'top'}}>Q5</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#B91C1C',verticalAlign:'top',lineHeight:1.5}}>Do you carry a revolving credit card balance (i.e., not paying the full amount each month)?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#7F1D1D',lineHeight:1.8}}>
                  <div>A. No – I always pay the full outstanding amount</div>
                  <div style={{color:'#DC2626'}}>B. Occasionally – a few times a year</div>
                  <div style={{color:'#DC2626'}}>C. Yes – I regularly carry a balance and pay only minimum</div>
                </div>
              </td>
            </tr>
            {/* Q6 - Red */}
            <tr style={{background:'#FECACA',borderBottom:'1px solid var(--border)'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#991B1B',verticalAlign:'top'}}>Q6</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#B91C1C',verticalAlign:'top',lineHeight:1.5}}>Do you have an active personal loan taken for consumption (not for buying an asset)?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#7F1D1D',lineHeight:1.8}}>
                  <div>A. No personal loan for consumption</div>
                  <div style={{color:'#DC2626'}}>B. Yes – one loan, actively paying it off</div>
                  <div style={{color:'#DC2626'}}>C. Yes – multiple personal/consumer loans active</div>
                </div>
              </td>
            </tr>
            {/* Q7 - Blue */}
            <tr style={{background:'#DBEAFE'}}>
              <td style={{padding:'14px 16px',fontWeight:700,color:'#1E40AF',verticalAlign:'top'}}>Q7</td>
              <td style={{padding:'14px 16px',fontWeight:600,color:'#1D4ED8',verticalAlign:'top',lineHeight:1.5}}>Do you invest regularly beyond savings accounts and Fixed Deposits?</td>
              <td style={{padding:'14px 16px',verticalAlign:'top'}}>
                <div style={{fontSize:'11px',color:'#1E3A8A',lineHeight:1.8}}>
                  <div>A. Yes – Regular SIP/stocks/MF investments</div>
                  <div>B. No – All savings kept only in FD or savings account</div>
                </div>
              </td>
            </tr>
          </tbody>
